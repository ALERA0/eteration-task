  ...
  return (
    <div className=" flex gap-8 h-full bg-[#F9F9F9]  w-full">
      <div className="md:grid md:grid-cols-2 flex flex-col w-full bg-white shadow-lg py-4 px-2 gap-4">
        <div className="bg-slate-500 w-full md:h-full bg-center bg-no-repeat bg-cover h-36"
        style={{
        ...
        <div className="col-span-1 flex flex-col gap-8">
          <div>
            ...
            <p className="text-[#2A59FE] text-xl ">{getProductDetailsData?.price}</p>
          </div>
          <button onClick={handleBasketClick} className="bg-[#2A59FE] text-white py-2 w-full rounded-lg hover:bg-blue-500 duration-200">
            Add to Cart
          </button>
          
          <p>
          {getProductDetailsData?.description}
          </p>
        </div>
      </div>
    </div>
